<template>
    <q-card>
        <q-card-section>
            ...
            <ul>
                <li>Ошибки - <a href="https://github.com/Naskalin/Relaks/issues" target="_blank">максимально подробно
                ...
                <li>Программа бесплатна, не стесняйтесь <a href="https://boosty.to/relaks" target="_blank">поддержать
                    проект рублём на Boosty</a>.
                </li>
            </ul>
        </q-card-section>
    </q-card>
