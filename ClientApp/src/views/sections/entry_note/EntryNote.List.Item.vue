<template>
    <q-card style="min-width: 600px">
        ...
        <q-card-section v-html="eText.val"></q-card-section>
        ...
        <q-card-section class="q-py-sm">
            <div class="row justify-between items-center">
                ...
                <div class="col-auto text-grey-8 q-gutter-x-md">
                    <span class="label-caption">{{ entryTextMessages.createdAt }}:</span>
                    {{ dateHelper.utcFormat(eText.createdAt) }}
                    <span class="label-caption">{{ entryTextMessages.updatedAt }}:</span>
...
import {actualMessages, entryTextMessages} from "../../../localize/messages";
