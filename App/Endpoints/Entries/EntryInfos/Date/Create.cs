    ...
    .WithActionResult
{
    ...
    public Create(
        EntryInfoDateRepository infoDateRepository,
        ...
        CancellationToken cancellationToken = new())
    {
        ...
        var eInfo = new EntryInfoDate {EntryId = entry.Id, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow};
        request.Details.MapTo(eInfo);
        await _infoDateRepository.CreateAsync(eInfo, cancellationToken);
